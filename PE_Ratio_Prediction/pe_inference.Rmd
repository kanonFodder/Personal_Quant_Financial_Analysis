...
equity_epu_link <- sprintf('https://fred.stlouisfed.org/graph/fredgraph.csv?id=WLEMUINDXD&vintage_date=%s&revision_date=%s&nd=1985-01-01',
...
```{r}
library(ggplot2)
covar_ret <- as.character(unlist(read.csv('covar_ret.csv',
                      row.names = 'X')))
...
print(tail(sp500_charData_apply))
